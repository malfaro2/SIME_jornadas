...
subtitle: "SIME 2019"
author: "Andrés Arguedas, Luis Diego Quirós, Marcela Alfaro Córdoba"
date: "1/2/2019"
output:
...
- Un *Shiny App* es una aplicación creada mediante la librería [`Shiny`](https://shiny.rstudio.com) de R.

--

- Esta librería permite, mediante scripts y comandos de R, crear aplicaciones interactivas, las cuales pueden ser publicadas en línea y utilizadas por otras personas.
...
- La Estadística Bayesiana es una rama de la Estadística, la cual se diferencia de la Estadística Frecuentista en que toma los parámetros de las distribuciones como variables aleatorias, en lugar de constantes

--

- Presenta un cambio de paradigma en la forma de estudiar la Estadística por lo que, en el curso de Teoría Estadística del Bachillerato en Estadística de la UCR, el último tema del curso es sobre la Estadística Bayesiana

--

- Históricamente los estudiantes de este curso han tenido problemas con este tema ya que implica una forma de pensar radicalmente distinto a lo que se ve en los temas anteriores del curso y la mayor parte de los cursos de la carrera

--

- Por lo anterior, en el primer semestre del 2018 se implementó en este curso un proyecto para la creación de aplicaciones en Shiny con temas relacionados a la Estadística Bayesiana, con el fin de facilitar la comprensión de estos conceptos por parte de los estudiantes
...
Los objetivos de aprendizaje que guiaron la actividad fueron:
...
3. Utilizar el producto final, para de esta forma asegurarse que las aplicaciones puedan ser utilizadas en otros cursos para facilitar la enseñanza de conceptos Bayesianos
...
- Se deben dar más talleres sobre *Shiny* desde que inicia el curso para que, las personas interesadas, puedan prepararse de forma efectiva y con tiempo para la realización de la activdad

--

- Por último, se podrían realizar evaluaciones antes y después de realizar la actividad, para poder medir el impacto de la realización de la actividad sobre la comprensión de la materia por parte de los estudiantes
